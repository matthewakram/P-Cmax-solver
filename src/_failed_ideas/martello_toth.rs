...
impl Bound for MartelloToth {
    fn bound(&self, problem: &ProblemInstance, lower_bound: usize, upper_bound: Option<problem_instance::solution::Solution>, _timeout: f64) -> (usize, Option<problem_instance::solution::Solution>) {
